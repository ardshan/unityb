...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EoZjo5vWq1LblZ8kryMc.TdwqQiqRNyPFQ2KZy3FRZa.MiGuJb5mSaCRMGM6ADSwiscjLpRGh8ntApcBI30QTxg=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EoZjo5vWq1LblZ8kryMc.TdwqQiqRNyPFQ2KZy3FRZa.MiGuJb5mSaCRMGM6ADSwiscjLpRGh8ntApcBI30QTxg=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EoZjo5vWq1LblZ8kryMc.TdwqQiqRNyPFQ2KZy3FRZa.MiGuJb5mSaCRMGM6ADSwiscjLpRGh8ntApcBI30QTxg=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EoZjo5vWq1LblZ8kryMc.TdwqQiqRNyPFQ2KZy3FRZa.MiGuJb5mSaCRMGM6ADSwiscjLpRGh8ntApcBI30QTxg=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EoZjo5vWq1LblZ8kryMc.TdwqQiqRNyPFQ2KZy3FRZa.MiGuJb5mSaCRMGM6ADSwiscjLpRGh8ntApcBI30QTxg=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='EoZjo5vWq1LblZ8kryMc.TdwqQiqRNyPFQ2KZy3FRZa.MiGuJb5mSaCRMGM6ADSwiscjLpRGh8ntApcBI30QTxg=')
km.loginResult()
...
╚═════════════════════════
"""
tjia="u136360f65010efb7f8dcad362cb2c3cc"
...
def bot(op):
    try:
	    ...
	    if mid in op.param3:
			...
			cl.sendText(op.param1,"☆Jika terjadi sesuatu hubungi own☆\n☆https://line.me/ti/p/%40bqs0815l")
	    else:
	 ...
	 if wait["Ghost"] == True:
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.append(target)
                            cl.sendText(msg.to,"Admin Unity Ditambahkan")
                        except:
                            pass
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Admin Unity Dihapus")
                        except:
                            pass
		...
		cl.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            elif msg.text in ["Help creator","Ub creator","ub creator"]:
                cl.sendText(msg.to,creatorMessage)

            elif msg.text in ["Ub group","ub group","Help group"]:
                cl.sendText(msg.to,groupMessage)

            elif msg.text in ["Key","help","Help"]:
                cl.sendText(msg.to,helpMessage)

            elif msg.text in ["Ub self","ub self","Help self"]:
                cl.sendText(msg.to,selfMessage)

            elif msg.text in ["Ub bot","ub bot","Help bot"]:
                cl.sendText(msg.to,botMessage)

            elif msg.text in ["Ub set","ub set","Help set"]:
                cl.sendText(msg.to,setMessage)

            elif msg.text in ["Ub media","ub media","Help media"]:
                cl.sendText(msg.to,mediaMessage)
                
            elif msg.text in ["Ub admin","ub admin","Help admin"]:
                cl.sendText(msg.to,adminMessage)    
                
            elif msg.text in ["Ub protect","ub protect","Help protect"]:
                cl.sendText(msg.to,protectMessage)              
			
			elif msg.text in ["Ub rhs","ub rhs","Help rhs"]:
                cl.sendText(msg.to,rhsMessage)   
				
            elif msg.text in ["Ub trans","ub trans","Help trans"]:
                cl.sendText(msg.to,tranMessage)   
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus Alevan")
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "u6b3f7e3b124ad8d9ed9261d351c91abf"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
		...
		if msg.from_ in Creator:
		    for i in gid:
			cl.sendText(i,"=======[NUMPANG BROADCAST]=======\n\n"+bc+"\n\nContact Me : line.me/ti/p/~shandiap")
            ...
            elif msg.text in ["Join all","kuy","unity"]:
		if msg.from_ in admin:
		...
		try:
		    ...
		    wait["Leave"] = False
		          ...
		          cl.sendText(msg.to,"Bilang Dulu Sama Admin Ku")		    
                    ...
                    kc.sendText(msg.to,"★★★★")
                    kr.sendText(msg.to,"★★★★★")
                    km.sendText(msg.to,"Semua Hadir Boss...!!!\n\n[✰ υnιтy тeaм вoт ✰]")
                
                
            elif msg.text in ["Test"]:
		cl.sendText(msg.to,"Masuk boss")
                ki.sendText(msg.to,"Masuk Kapten")
                kk.sendText(msg.to,"Masuk  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"Keluar  \(ˆ▿ˆ)/")
                kr.sendText(msg.to,"Naon eta teh  \(ˆ▿ˆ)/")
            ...
            elif msg.text in ["Sp test","Speed test"]:
                start = time.time()
                print("Speed")                
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                link = ["ttps://goo.gl/images/LLZj93"]
...
#==============================================
                ...
                if msg.from_ in owner:
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                            ...
                            kr.sendText(g.mid,'spam')
                            kr.sendText(g.mid,'spam')
                            kr.sendText(g.mid,'hi')
                            kr.sendText(msg.to, "Selesai di Spam")
                            print " Spammed !"
		...
		if msg.from_ in Creator:
              ...
              if msg.from_ in Creator:
                ...
                rnd = ["kapan kapan","besok","satu abad lagi","Hari ini","Tahun depan","Minggu depan","Bulan depan","Sebentar lagi","Tidak Akan Pernah","Nunggu bot ga jomblo:'v"]
                p = random.choice(rnd)
                lang = 'id'
                tts = gTTS(text=p, lang=lang)
                tts.save("hasil.mp3")
...
#              if msg.from_ in admin:
            ...
            elif "Cekkelahiran " in msg.text:
                tanggal = msg.text.replace("Cekkelahiran ","")
			...
			elif msg.text in ["Ub","ub"]:
		cl.sendText(msg.to,"Masih on boss")
                ki.sendText(msg.to,"Disini kapten")
                kk.sendText(msg.to,"Hadir  \(ˆ▿ˆ)/")
